...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'myv_NujanjVidjaz-Erjzdentj-arsezj_2010-PICTXT.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Эрязденть арсезь'"/>
    <!--
    ...
    <!-- Automatically filled in by CorpusTools -->
    <xsl:variable name="mainlang" select="'myv'"/>
    ...
    <language xml:lang="myv"/><language xml:lang="rus"/></xsl:variable>
